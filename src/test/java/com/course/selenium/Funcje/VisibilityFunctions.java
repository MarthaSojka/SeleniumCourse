package com.course.selenium.Funcje;
...
public class VisibilityFunctions {
    ...
    @Test
    public void elementsVisibility_Test() {
        ...
        if (driver.findElement(FIRST_NAME_INPUT).isDisplayed()){
            System.out.println("FIRST_NAME_INPUT is displayed");
        } else {
            Assert.fail();
        }
        ...
        if (driver.findElement(LAST_NAME_INPUT).isDisplayed()){
            System.out.println("LAST_NAME_INPUT is displayed");
        } else {
            Assert.fail();
        }
        ...
        if (driver.findElement(EMAIL).isDisplayed()){
            System.out.println("EMAIL_INPUT is displayed");
        } else {
            Assert.fail();
        }

        if (driver.findElement(PASSWORD).isDisplayed()){
            System.out.println("PASSWORD_INPUT is displayed");
        } else {
            Assert.fail();
        }
        ...
        */
        ...
        if (driver.findElement(REGISTER).isDisplayed()){
            System.out.println("REGISTER_BUTTON is displayed");
        } else {
            Assert.fail();
        }
